...
class InventoryScreen extends StatefulWidget {
  final String shopID; // keep parameter (will be uid)
  ...
  Widget _buildInventoryList() {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (items.isEmpty) return _emptyStateViewOnly();
    ...
    return Center(
      child: Column(
        ...
        children: const [
          ...
          SizedBox(height: 8),
          Text("View only mode (Junkshop)", style: TextStyle(color: Colors.grey)),
        ],
      ),
    );
  }
